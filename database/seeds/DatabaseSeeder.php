    ...
    public function run(){
        ...
        DB::unprepared(
            "
              ...
              INSERT INTO estados (id, nome, uf, pais, regiao) VALUES
            (1, 'Acre', 'AC', 1, 1),
            (2, 'Alagoas', 'AL', 1, 2),
            (3, 'Amazonas', 'AM', 1, 1),
            (4, 'Amapá', 'AP', 1, 1),
            (5, 'Bahia', 'BA', 1, 2),
            (6, 'Ceará', 'CE', 1, 2),
            (7, 'Distrito Federal', 'DF', 1, 3),
            (8, 'Espírito Santo', 'ES', 1, 4),
            (9, 'Goiás', 'GO', 1, 3),
            (10, 'Maranhão', 'MA', 1, 2),
            (11, 'Minas Gerais', 'MG', 1, 4),
            (12, 'Mato Grosso do Sul', 'MS', 1, 3),
            (13, 'Mato Grosso', 'MT', 1, 3),
            (14, 'Pará', 'PA', 1, 1),
            (15, 'Paraíba', 'PB', 1, 2),
            (16, 'Pernambuco', 'PE', 1, 2),
            (17, 'Piauí', 'PI', 1, 2),
            (18, 'Paraná', 'PR', 1, 5),
            (19, 'Rio de Janeiro', 'RJ', 1, 4),
            (20, 'Rio Grande do Norte', 'RN', 1, 2),
            (21, 'Rondônia', 'RO', 1, 1),
            (22, 'Roraima', 'RR', 1, 1),
            (23, 'Rio Grande do Sul', 'RS', 1, 5),
            (24, 'Santa Catarina', 'SC', 1, 5),
            (25, 'Sergipe', 'SE', 1, 2),
            (26, 'São Paulo', 'SP', 1, 4),
            (27, 'Tocantins', 'TO', 1, 1);
            ...
            (1388, 'Dom Aquino', 13),
            (1389, 'Feliz Natal', 13),
            (1390, 'Figueirópolis de Oeste', 13),
            (1391, 'Gaúcha do Norte', 13),
            (1392, 'General Carneiro', 13),
            (1393, 'Glória de Oeste', 13),
